      ...
      <main className="container py-16 max-w-3xl">
        <article className="prose prose-sm max-w-none">
          ...
          <p className="mb-8">
            ...
            Tutor Atlas website at <strong>{WEBSITE_URL}</strong> (the "Site").
          ...
          <p className="mb-6">
            Tutor Atlas is currently in concept validation and early access
            stage. The Site provides information about Tutor Atlas and allows
            you to submit your details for early access, interviews, and related
            updates.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li>
              Attempt to disrupt or compromise the Site (e.g., hacking,
              scraping, spamming)
            </li>
            <li>Upload or transmit malicious code</li>
          </ul>
          <p className="mb-6">
            We may restrict access to the Site or its forms if we suspect
            misuse.
          </p>

          <h2 className="text-2xl font-bold mt-10 mb-4">
            3. Early access and interviews
          </h2>
          <p className="mb-6">
            Submitting your details does not guarantee admission into any early
            access program. We may select participants based on availability and
            research needs.
          </p>
          ...
          <p className="mb-6">
            All content on the Site (including text, logos, and designs) is
            owned by or licensed to Tutor Atlas and is protected by applicable
            laws. You may not reproduce or distribute Site content without our
          ...
          <p className="mb-6">
            ...
            Nothing on the Site constitutes professional advice.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li>
              We do not warrant that any information on the Site is complete,
              accurate, or up to date
            </li>
          </ul>
          <p className="mb-6">
            Where the Site references commute estimates (e.g., in product
            descriptions), such estimates are illustrative and may vary based on
            real-world conditions and third-party data sources.
          </p>
          ...
          <p className="mb-6">
            To the maximum extent permitted by law, Tutor Atlas will not be
            liable for any indirect, incidental, special, consequential, or
            punitive damages, or any loss of profits or revenue, arising from or
          ...
          <p className="mb-6">
            ...
            updated Terms will be posted on the Site with a new effective date.
          ...
          <p className="mb-6">
            These Terms are governed by the laws of Singapore. You agree to
